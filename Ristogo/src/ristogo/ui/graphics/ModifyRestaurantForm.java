...
///////////////////////////////////////////////////////////////////////////////
		...
		/*
		 * FILL FORM WITH RESTAURANT try { RestaurantBean r =
		 * (RestaurantBean)MessageHandler.sendRequest(MessageHandler.RESTAURANT_INFO);
		 * if(r.getName() != null) { nameField.setText(r.getName());
		 * typeField.getSelectionModel().select(r.getType());
		 * costField.setValue(r.getPrice()); cityField.setText(r.getCity());
		 * addressField.setText(r.getAddress()); descField.setText(r.getDescription());
		 * seatsField.setText(new Integer(r.getSeats()).toString()); }
		 * if(r.getOpening().equals("LUNCH")) {
		 * hourField.getSelectionModel().select("Lunch"); } else
		 * if(r.getOpening().equals("DINNER")) {
		 * hourField.getSelectionModel().select("Dinner"); } else {
